...
| 011 | 10seed_250k_time_tail | baseline / baseline_plus_time_tail | 250,000 | 0-9 | Ten-seed confirmation: time-tail improves early clear/cap/stuck and penalized completion, with lower mean progress. Ready for a cautious stability/sample-efficiency write-up. |
